## R file which cache matrix inverse in order to make it faster
## File has two functions: makeCacheMatrix and cacheSolve
...
## of the data and sets the value of the inverse in the cache 
